    ...
    public class SalesReturnService : ISalesReturn
    {
        ...
        public bool CreateBill(CSalesReturn oSalesReturn, string billType)
        {
            ...
            lock (Synchronizer.@lock)
            {
                ...
                using (var dataB = new Database9005Entities())
                {
        ...
        //Reports
        public List<CSalesReturnReportDetailed> FindSalesReturnDetailed(DateTime startDate, DateTime endDate, string billType, string billNo, string customerCode, string customer, string productCode, string product, string narration, string financialCode)
        {
        ...
        public List<CSalesReturnReportSummary> FindSalesReturnSummary(DateTime startDate, DateTime endDate, string billType, string billNo, string customerCode, string customer, string productCode, string product, string narration, string financialCode)
        {
